...
public class MatrixProfile_demo {
    public static void main(String[] args) throws Exception
    {
        ...
        jsonObject.put("subDataSet", "matrix-profile_demo");
        jsonObject.put("description", "matrix-profile_demo");
        ...
        jsonArrayField.add("auto_field0");
        ...
        jsonObject.put("table","matrix-profile_demo");
