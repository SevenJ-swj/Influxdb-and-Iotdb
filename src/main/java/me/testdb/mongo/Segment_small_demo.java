...
public class Segment_small_demo {
    public static void main(String[] args)
    {
        ...
        jsonObject.put("subDataSet", "segment_small_demo");
        jsonObject.put("description", "segment_small_demo");
        ...
        jsonObject.put("table","segment_small_demo");
